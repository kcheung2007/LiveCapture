// From Miscrosoft sample: Generating XML Documents from XML Schemas
...
namespace Microsoft.Xml.XMLGen
{
    ...
    internal class Generator_integer : Generator_decimal
    {
        ...
        public Generator_integer(CompiledFacets rFacets)
            : base( rFacets )
        {
            step = 1;
        }
    ...
    {
        public Generator_date(CompiledFacets rFacets)
            : base( rFacets )
        {
        }
    ...
    { //A derived type of token
        ...
        public Generator_language(CompiledFacets rFacets)
            : base( rFacets )
        {
        }
    ...
    internal class Generator_NMTOKEN : Generator_token
    {
        ...
        public Generator_NMTOKEN(CompiledFacets rFacets)
            : base( rFacets )
        {
        }
    }
